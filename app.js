...
//parents = String, noOfSiblings = Number, isNuclerFamily = Boolean
function moreAboutKaren(parents,noOfSiblings,isNuclerFamily){
    if(typeof(parents)=="string" && typeof(noOfSiblings)=="number" && typeof(isNuclerFamily)=="boolean")
        return true;
    else
        return false;
}
